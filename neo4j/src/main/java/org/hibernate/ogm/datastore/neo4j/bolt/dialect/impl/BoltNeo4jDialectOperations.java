 ...
 */
public final class BoltNeo4jDialectOperations {

	private BoltNeo4jDialectOperations() {
	}

	public static Map<String, Node> findToOneEntities(Transaction tx, NodeWithEmbeddedNodes owner, EntityKey entityKey, TupleContext tupleContext, BoltNeo4jEntityQueries queries) {
		return findToOneEntities( tx, owner, entityKey.getMetadata(), tupleContext, queries );
	}

	public static Map<String, Node> findToOneEntities(Transaction tx, NodeWithEmbeddedNodes node, EntityKeyMetadata entityKeyMetadata, TupleContext tupleContext, BoltNeo4jEntityQueries queries) {
