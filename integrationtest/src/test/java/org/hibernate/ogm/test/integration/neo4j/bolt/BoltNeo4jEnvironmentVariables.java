...
import org.hibernate.ogm.datastore.neo4j.bolt.impl.BoltNeo4jConfiguration;

/**
 * @author Davide D'Alto
 */
public class BoltNeo4jEnvironmentVariables {
	...
	private static void setPortNumber() {
		...
		if ( isNull( neo4jPortNumber ) ) {
			neo4jPortNumber = String.valueOf( BoltNeo4jConfiguration.DEFAULT_PORT );
		}
	}
