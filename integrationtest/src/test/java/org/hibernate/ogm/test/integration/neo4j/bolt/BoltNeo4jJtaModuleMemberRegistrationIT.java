 ...
 */
package org.hibernate.ogm.test.integration.neo4j.bolt;

import static org.hibernate.ogm.test.integration.neo4j.bolt.BoltNeo4jEnvironmentVariables.getNeo4jHost;
import static org.hibernate.ogm.test.integration.neo4j.bolt.BoltNeo4jEnvironmentVariables.getNeo4jPassword;
import static org.hibernate.ogm.test.integration.neo4j.bolt.BoltNeo4jEnvironmentVariables.getNeo4jUsername;
...
public class BoltNeo4jJtaModuleMemberRegistrationIT extends ModuleMemberRegistrationScenario {

	@Deployment
	public static Archive<?> createTestArchive() throws Exception {
		return new ModuleMemberRegistrationDeployment
				.Builder( BoltNeo4jJtaModuleMemberRegistrationIT.class )
