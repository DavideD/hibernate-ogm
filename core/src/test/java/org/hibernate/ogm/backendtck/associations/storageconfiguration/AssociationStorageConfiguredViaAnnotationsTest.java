 ...
 */
@SkipByGridDialect(
		value = { GridDialectType.EHCACHE, GridDialectType.HASHMAP, GridDialectType.INFINISPAN, GridDialectType.NEO4J_EMBEDDED, GridDialectType.NEO4J_BOLT, GridDialectType.CASSANDRA, GridDialectType.REDIS_HASH },
