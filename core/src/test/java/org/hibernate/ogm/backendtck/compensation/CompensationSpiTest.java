...
public class CompensationSpiTest extends OgmTestCase {
	...
	@Test
	@SkipByGridDialect(
			value = { GridDialectType.NEO4J_EMBEDDED, GridDialectType.NEO4J_BOLT, GridDialectType.INFINISPAN, GridDialectType.EHCACHE },
	...
	@Test
	@SkipByGridDialect(
			value = { GridDialectType.NEO4J_EMBEDDED, GridDialectType.NEO4J_BOLT },
